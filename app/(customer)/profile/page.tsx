    ...
    try {
      ...
      if (imageFile) {
        ...
        if (!res.ok || d.error) {
          ...
          setLoading(false)
          return  // Stop here — don't save profile with broken photo
        }
      ...
      const profileRes = await fetch('/api/user/profile', {
        ...
        body: JSON.stringify({ name, phone, allergies, ...(imageUrl ? { image: imageUrl } : {}) }),
      })
        ...
        <div className="space-y-4">
          ...
          <div>
            ...
            <Input
              ...
              disabled
              className="mt-1 ag-input opacity-50 cursor-not-allowed"
            />
          </div>
          ...
          {/* ── Allergies ──────────────────────────────────────── */}
          <div>
            <Label className="text-white/70 text-sm">Food Allergies</Label>
